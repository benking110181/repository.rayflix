...
def main_menu():
	...
	add_dir("[COLOR deepskyblue]2 CHOISIR PACKS SKIN : [/COLOR] Sélectionner le pack souhaité", 'light_light', 'call_save', artworkPath + 'icone.png')
	add_dir("LIGHT - STANDARD ([COLOR deepskyblue]le + leger[/COLOR])", 'light_light', 'call_save', artworkPath + 'icone.png')
	add_dir("FULL - STANDARD", 'full_full', 'call_save', artworkPath + 'icone.png')
	add_dir("FULL - PERSO ([COLOR deepskyblue]le skin de Rayflix[/COLOR])", 'full_perso', 'call_save', artworkPath + 'icone.png')
	add_dir("LIGHT - KIDS", 'light_kids', 'call_save', artworkPath + 'icone.png')
	add_dir("FULL - KIDS", 'full_kids', 'call_save', artworkPath + 'icone.png')
	add_dir("LIGHT - SERIES (a venir)", 'light_series', 'call_save', artworkPath + 'icone.png')
	add_dir("FULL - SERIES", 'full_series', 'call_save', artworkPath + 'icone.png')
	add_dir("LIGHT - FILMS (a venir)", 'light_films', 'call_save', artworkPath + 'icone.png')
	add_dir("FULL - FILMS (a venir)", 'full_films', 'call_save', artworkPath + 'icone.png')
